...
;
var CarouselInit = {
    InitHomepage6Products: function InitHomepage6Products() {
    ...
    InitHomepage4Products: function InitHomepage4Products() {
        if ($(window).width() > 1199) {
...
$(document).ready(function () {
    ...
    $('.product-nav').slick((_$$slick = {
        ...
        focusOnSelect: true,
        swipe: true
    }, _defineProperty(_$$slick, 'swipeToSlide', true), _defineProperty(_$$slick, 'vertical', true), _defineProperty(_$$slick, 'verticalSwiping', true), _$$slick));
    ...
    if ($('.popup-tragop').length) $('.popup-tragop').appendTo("main");
    ...
    $('.video-popup-link').click(function () {
        $('.popup-tragop').html('<div class="bank-list" style="padding:0"><iframe width="400" height="350" frameborder="0" allowfullscreen="" src="' + $(this).attr('href') + '"></iframe ><div class="text-center order-info mt-2 mb-2"><a href="#" class="close-popup-button userpanel-cancel-btn">Đóng</a></div></div>').addClass('active');
        return false;
    });
